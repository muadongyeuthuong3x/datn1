...
import { apiGetListExam, deleteItemExam, createExam, searchDataApi, editDataExamApi } from '../slices/examForm'
...
const ExamFormComponent = () => {
    ...
    const { data } = useSelector(state => state.listExamForm)
    ...
    return (
        <div>
            <div className='form_search'>
                <Button type='primary' onClick={showModalCreate}>Tạo hình thức thi</Button>
            ...
            {/* Modal delete */}
            <Modal title="Delete hình thức thi" open={isModalOpenDelete} onOk={handleOkDelete} onCancel={handleCancelDelete}>
            ...
            {/* Modal Create */}
            <Modal title="Tạo hình thức thi" open={isModalOpenCreate} footer={null}>
            ...
            {/* Modal Edit */}
            <Modal title="Edit hình thức thi" open={isModalOpenEdit} footer={null}>
